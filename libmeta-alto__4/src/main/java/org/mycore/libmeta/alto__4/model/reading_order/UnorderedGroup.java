...
/**
 * A group containing unordered elements 
 * (i.e. the sequence of OrderedGroup, UnorderedGroup or ElementRef subelements is arbitrary).
 * 
 * @author Robert Stephan
 * @version Alto 4.4
  */
@XmlAccessorType(XmlAccessType.NONE)
public class UnorderedGroup implements IReadingOrderChild, IGroupChild, IElementRefAttributeGroup {
    ...
    public static Builder builder() {
        return builder(new UnorderedGroup());
    }

    public static Builder builder(UnorderedGroup unorderedGroup) {
        return new Builder(unorderedGroup);
    }

    public static class Builder extends BuilderBase<UnorderedGroup, Builder>
        implements IElementRefAttributeGroupBuilder<UnorderedGroup, Builder> {

        protected Builder(UnorderedGroup unorderedGroup) {
