 ...
 *
 */
public class LanguageOfCataloging extends Language implements IRecordInfoSubelement {

    public static Builder builder() {
        return builder(new LanguageOfCataloging());
    }

    public static Builder builder(LanguageOfCataloging l) {
