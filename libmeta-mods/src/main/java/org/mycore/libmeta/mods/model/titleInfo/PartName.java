...
public class PartName extends StringPlusLanguage implements ITitleInfoSubelement, ISubjectTitleInfoSubelement {
    public static Builder builder() {
        return builder(new PartName());
    }

    public static Builder builder(PartName partName) {
