...
public class MarcTest {
    ...
    private static String XML_DARWIN = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
    ...
    public void testMarcXMLProcessor() {
        try {
            MarcRecord mr = (MarcRecord) MarcXMLProcessor.getInstance().unmarshal(XML_DARWIN);
